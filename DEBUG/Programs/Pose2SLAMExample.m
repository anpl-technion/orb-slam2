...
graph.add(BetweenFactorPose2(4, 2, Pose2(2, 0, pi/2), model));
...
isam.getFactorsUnsafe

%% Add pose constraint
inc_graph = NonlinearFactorGraph;
inc_graph.add(BetweenFactorPose2(5, 2, Pose2(2, 0, pi/2), model));

remFac_keys = gtsam.KeyVector;
remFac_keys.push_back(5);
isam.update(inc_graph, Values, remFac_keys);
isam.getFactorsUnsafe
